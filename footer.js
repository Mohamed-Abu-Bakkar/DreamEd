function renderFooter() {
    ...
    <footer class="bg-blue-950 w-full pt-16 pb-8 text-white relative overflow-hidden">
        <!-- Decorative elements -->
        <div class="absolute top-0 right-0 w-64 h-64 bg-primary-container/20 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2"></div>
        <div class="absolute bottom-0 left-0 w-48 h-48 bg-secondary/10 rounded-full blur-[80px]"></div>
        
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 px-8 max-w-7xl mx-auto mb-16 relative z-10">
            <div class="space-y-6">
                ...
                <div class="flex gap-3">
                    <a class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-yellow-500 hover:text-blue-950 transition-all duration-300 group" href="https://facebook.com" target="_blank">
                    ...
                    <a class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-yellow-500 hover:text-blue-950 transition-all duration-300 group" href="https://instagram.com" target="_blank">
                    ...
                    <a class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-yellow-500 hover:text-blue-950 transition-all duration-300 group" href="https://linkedin.com" target="_blank">
                    ...
                    <a class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-yellow-500 hover:text-blue-950 transition-all duration-300 group" href="https://twitter.com" target="_blank">
            ...
            <div class="bg-white/5 p-6 rounded-2xl border border-white/10">
                ...
                <div class="flex flex-col gap-3">
                    <input class="bg-white/10 border border-white/10 rounded-lg text-sm py-3 px-4 focus:ring-2 focus:ring-yellow-500 focus:border-transparent text-white placeholder:text-slate-500 transition-all" placeholder="Your Email" type="email"/>
                    <button class="bg-yellow-500 text-blue-950 font-bold py-3 rounded-lg text-sm hover:bg-yellow-400 hover:shadow-lg transition-all">Subscribe</button>
                </div>
                <p class="text-[10px] text-slate-500 mt-3">By subscribing, you agree to our Privacy Policy.</p>
            </div>
        </div>
        <div class="border-t border-white/10 pt-8 px-8 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
    ...
    <!-- Floating Contact & Conversion Buttons -->
    <div class="fixed bottom-8 right-8 flex flex-col gap-4 z-[100]">
        <!-- Scroll to Top -->
        <button id="scroll-to-top" class="w-12 h-12 bg-white text-primary rounded-full flex items-center justify-center shadow-lg hover:bg-secondary-container hover:text-on-secondary-container transition-all opacity-0 invisible" onclick="scrollToTop()">
            <span class="material-symbols-outlined">keyboard_arrow_up</span>
        </button>
        <!-- WhatsApp Button -->
        <a class="w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 hover:shadow-3xl transition-all" href="https://wa.me/1234567890" target="_blank" title="Chat on WhatsApp">
        ...
        <!-- Call Button -->
        <a class="w-14 h-14 bg-primary text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 hover:shadow-3xl transition-all" href="tel:+1234567890" title="Call Now">
